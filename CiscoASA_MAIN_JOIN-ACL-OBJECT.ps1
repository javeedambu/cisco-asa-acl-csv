...
Write-Host "$(Get-Date) ..... Converting AccessLists to CSV ....."
$AclObjects = & .\CiscoASA_ACL-to-CSV.ps1

# Execute the OBJECT extraction script
Write-Host "$(Get-Date) ..... Converting Objects to CSV ....."
...
Write-Host "$(Get-Date) ..... Expanding Objects in the AccessLists ....."
...
Write-Host "$(Get-Date) ..... Exporting final output to CSV ....."
...
Write-Host "$(Get-Date) ..... Opening the exported CSV ....."
